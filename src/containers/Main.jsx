...
class Main extends Component {
    ...
    renderStatementText(){
        return { __html: this.props.statementText };
    }
    ...
    renderStatementLead(){
        return { __html: this.props.statementLeadin }
    }
                    ...
                    <div className="unit" >
                        <div id="congress">
                            <div>
                                ...
                                <div dangerouslySetInnerHTML={this.renderStatementText()}/>
                            </div>
                        </div>
                    <hr/>
                        <div style={{color: 'white'}}>
                            <div dangerouslySetInnerHTML={this.renderAboutText()}>
